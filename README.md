...
| Every control in the app | **28 buttons clicked, 7 tabs opened, 18 routes called** (`npm run check:ui`): no console errors, no blank page, and every route answers with the shape the UI expects |
