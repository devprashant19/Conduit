...
export default function DownloadMatrixSection() {
  ...
  const handleDownload = (filename: string) => {
    // Direct static download endpoint
  ...
  return (
    <section className="landing-section download-matrix-section" id="download">
        ...
        {detected && (
          <div className="primary-detected-download">
            <button
              ...
              onClick={() => handleDownload(detected.downloadFilename)}
            >
              ...
              <div className="download-btn-content">
                ...
                <span className="download-sub-text">v1.0.0 · {detected.architecture} · Free & Open Source</span>
              </div>
            </button>
          </div>
        )}
